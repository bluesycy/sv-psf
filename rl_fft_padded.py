"""
Richardson-Lucy deconvolution — custom FFT-based with reflect padding
to reduce boundary artefacts from circular convolution
"""
import numpy as np
import nrrd
...
OUTPUT_PREFIX = "/nfs/data28/chuyu/data/20260109_095628/reference_stack_epi_RL_deconv_padded_iter"
...
# set up padded estimate and precompute FFTs once
...
print(f"Running padded FFT RL up to {max_iter} iterations, checkpoints: {checkpoints}")
